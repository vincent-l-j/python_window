...
class PyGrid(object):
    KEYS = {
        latin1.XK_m: {'name':'bottomleft',  'filter':lambda s: s.x1 == 0.0 and s.y2 == 1.0},
        latin1.XK_comma: {'name':'bottom',      'filter':lambda s: s.y2 == 1.0 and _center(s.x1,s.x2)},
        latin1.XK_period: {'name':'bottomright', 'filter':lambda s: s.x2 == 1.0 and s.y2 == 1.0},
        latin1.XK_j: {'name':'left',        'filter':lambda s: s.x1 == 0.0 and _center(s.y1,s.y2)},
        latin1.XK_k: {'name':'middle',      'filter':lambda s: _center(s.x1,s.x2) and _center(s.y1,s.y2)},
        latin1.XK_l: {'name':'right',       'filter':lambda s: s.x2 == 1.0 and _center(s.y1,s.y2)},
        latin1.XK_u: {'name':'topleft',     'filter':lambda s: s.x1 == 0.0 and s.y1 == 0.0},
        latin1.XK_i: {'name':'top',         'filter':lambda s: s.y1 == 0.0 and _center(s.x1,s.x2)},
        latin1.XK_o: {'name':'topright',    'filter':lambda s: s.x2 == 1.0 and s.y1 == 0.0},
    }
